...
public class RollsTransformerTest {
	...
	public void setUp() {
		...
		rolls.put("Carl 1", Arrays.asList("F", "10", "1", "0", "5", "5", "5", "5", "5", "4", "5", "4", "5", "4", "5", "4", "5", "4", "5", "4"));
		rolls.put("Carl 2", Arrays.asList("10", "3", "7", "0", "F", "5", "5", "5", "5", "4", "5", "4", "5", "4", "5", "4", "5", "4", "5", "4"));
		...
		rollsScore.put("Carl 1", Arrays.asList("F", "10", "1", "0", "5", "5", "5", "5", "5", "4", "5", "4", "5", "4", "5", "4", "5", "4", "5", "4"));
		rollsScore.put("Carl 2", Arrays.asList("10", "3", "7", "0", "F", "5", "5", "5", "5", "4", "5", "4", "5", "4", "5", "4", "5", "4", "5", "4"));
	...
	public void testValidRoundsScores() {
		PlayerInfo player1= playersScore.get(0);
		PlayerInfo player2= playersScore.get(1);
		PlayerInfo player3= playersScore.get(2);
		final List<Round> rounds1 = player1.getRounds();
		final List<Round> rounds2 = player2.getRounds();
